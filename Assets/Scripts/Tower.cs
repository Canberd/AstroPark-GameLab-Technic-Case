...
public class Tower : MonoBehaviour
{
    ...
    IEnumerator BuildTowerCoroutine()
    {
            ...
            foreach (int towerHumanCount in towerCountList)
            {
                ...
                tower.transform.parent = PlayerManager.PlayerManagerInstance.stickmanParent;
                ...
                {
                    Transform child = PlayerManager.PlayerManagerInstance.stickmanParent.GetChild(i);
